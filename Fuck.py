...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/KAZI2135kK/Aprooval.txt/blob/main/Aprooval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            KAZI SAMIR
     \033[1;91m➣ \033[1;92mFACEBOOK   :            FOURKAN UDDIN TANVIR
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01817313151
     \033[1;96m➣ \033[1;92mGITHUB     :            kazi samir
     \033[1;95m➣ \033[1;92mTOOLS      :            UID CLON
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    """)
		print("%s [%sâ€¢%s] %sTOOL NAME : %sUID CLON"%(G,R,G,Y,G))
		print("%s [%sâ€¢%s] %sVERSION   : %s1.0"%(G,R,G,Y,G))
		print("%s [%sâ€¢%s] %sYOUR KEY  : %s%s"%(k,a,0,key))
